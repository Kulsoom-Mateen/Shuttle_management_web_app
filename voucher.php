...
<body>
                ...
                <div class="form-area">
                    <form class="sign" method="get" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"><br>
                        ...
                        <?php 
                            ...
                            echo 'Valid upto :&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp ';
    ...
    <script>
        ...
        function userbackbutton(){
            location.replace("http://localhost/user/user_panel.php?name=<?php echo $name1;?>")
        }
    </script>
</body>
