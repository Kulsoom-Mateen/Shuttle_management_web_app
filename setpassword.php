...
<body>
    ...
    <div class="reg">
        <div class="registered"><p style="padding:190px 0px 0px 0px;">Your password has been reset</p></div>
        <button class="button" type="submit" name="OK" onclick="ok()">OK</button>
    </div>
<script>
    function ok(){
        location.replace("http://localhost/WEB_PROJECT(WE)/user/login1.php");
    }
</script>
</body>