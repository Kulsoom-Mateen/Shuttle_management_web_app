...
$name = $rollno = $year = $department = $type = $email = $password = $payment = "";


$sql="select * from passenger where p_name='$name1'";
                ...
                <div class="form-area">
                    ...
                    <p>
                        <?php 
                            ...
                            echo $name.'<br><br><br>';
                            echo 'Roll no. :&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp ';
                            echo $rollno.'<br><br><br>';
                            echo 'Year :&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp ';
                            echo $year.'<br><br><br>';
                            echo 'Department : &nbsp&nbsp&nbsp&nbsp&nbsp';
                            echo $department.'<br><br><br>';
                            echo 'Type :&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp ';
                            echo $type.'<br><br><br>';
                            ...
                            echo 'Payment :&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp';
                            echo $payment.'<br><br><br>';
                        ?>
                    </p>
